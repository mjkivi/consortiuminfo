...
class LibraryDiscoveryIntegrationTest extends KernelTestBase {
  ...
  public function testLibrariesOverride() {
    ...
    $this->activateTheme('classy');
    $this->assertAssetInLibrary('core/themes/classy/consortiuminfo2017/css/components/button.css', 'classy', 'base', 'css');
    $this->assertAssetInLibrary('core/themes/classy/consortiuminfo2017/css/components/collapse-processed.css', 'classy', 'base', 'css');
    $this->assertAssetInLibrary('core/themes/classy/consortiuminfo2017/css/components/container-inline.css', 'classy', 'base', 'css');
    $this->assertAssetInLibrary('core/themes/classy/consortiuminfo2017/css/components/details.css', 'classy', 'base', 'css');
    $this->assertAssetInLibrary('core/themes/classy/consortiuminfo2017/css/components/dialog.css', 'classy', 'dialog', 'css');
    ...
    $this->assertNoAssetInLibrary('core/themes/classy/consortiuminfo2017/css/components/button.css', 'classy', 'base', 'css');
    $this->assertNoAssetInLibrary('core/themes/classy/consortiuminfo2017/css/components/collapse-processed.css', 'classy', 'base', 'css');
    $this->assertNoAssetInLibrary('core/themes/classy/consortiuminfo2017/css/components/container-inline.css', 'classy', 'base', 'css');
    $this->assertNoAssetInLibrary('core/themes/classy/consortiuminfo2017/css/components/details.css', 'classy', 'base', 'css');
    $this->assertNoAssetInLibrary('core/themes/classy/consortiuminfo2017/css/components/dialog.css', 'classy', 'dialog', 'css');

    $this->assertAssetInLibrary('core/modules/system/tests/themes/test_theme/consortiuminfo2017/css/my-button.css', 'classy', 'base', 'css');
    $this->assertAssetInLibrary('core/modules/system/tests/themes/test_theme/consortiuminfo2017/css/my-collapse-processed.css', 'classy', 'base', 'css');
    $this->assertAssetInLibrary('themes/my_theme/consortiuminfo2017/css/my-container-inline.css', 'classy', 'base', 'css');
    $this->assertAssetInLibrary('themes/my_theme/consortiuminfo2017/css/my-details.css', 'classy', 'base', 'css');
  ...
  public function testLibrariesOverrideOtherAssetLibraryNames() {
    ...
    $this->assertAssetInLibrary('themes/my_theme/consortiuminfo2017/css/dropbutton.css', 'core', 'drupal.dropbutton', 'css');
    ...
    $this->assertAssetInLibrary('//my-server/my_theme/consortiuminfo2017/css/jquery_ui.css', 'core', 'jquery.ui', 'css');

    // Assert an absolute URI.
    $this->assertAssetInLibrary('http://example.com/my_theme/consortiuminfo2017/css/farbtastic.css', 'core', 'jquery.farbtastic', 'css');
  }
  ...
  public function testBaseThemeLibrariesOverrideInSubTheme() {
    ...
    $this->assertAssetInLibrary('core/modules/system/tests/themes/test_basetheme/consortiuminfo2017/css/farbtastic.css', 'core', 'jquery.farbtastic', 'css');
  }
  ...
  public function testLibrariesExtend() {
    ...
    $this->activateTheme('classy');
    $this->assertNoAssetInLibrary('core/modules/system/tests/themes/test_theme_libraries_extend/consortiuminfo2017/css/extend_1.css', 'classy', 'book-navigation', 'css');
    ...
    $this->assertNoAssetInLibrary('core/modules/system/tests/themes/test_theme_libraries_extend/consortiuminfo2017/css/extend_2.css', 'classy', 'book-navigation', 'css');

    // Activate the theme that extends the book-navigation library in classy.
    $this->activateTheme('test_theme_libraries_extend');
    $this->assertAssetInLibrary('core/modules/system/tests/themes/test_theme_libraries_extend/consortiuminfo2017/css/extend_1.css', 'classy', 'book-navigation', 'css');
    ...
    $this->assertAssetInLibrary('core/modules/system/tests/themes/test_theme_libraries_extend/consortiuminfo2017/css/extend_2.css', 'classy', 'book-navigation', 'css');

    // Activate a sub theme and confirm that it inherits the library assets
    // extended in the base theme as well as its own.
    $this->assertNoAssetInLibrary('core/modules/system/tests/themes/test_basetheme/consortiuminfo2017/css/base-libraries-extend.css', 'classy', 'base', 'css');
    $this->assertNoAssetInLibrary('core/modules/system/tests/themes/test_subtheme/consortiuminfo2017/css/sub-libraries-extend.css', 'classy', 'base', 'css');
    $this->activateTheme('test_subtheme');
    $this->assertAssetInLibrary('core/modules/system/tests/themes/test_basetheme/consortiuminfo2017/css/base-libraries-extend.css', 'classy', 'base', 'css');
    $this->assertAssetInLibrary('core/modules/system/tests/themes/test_subtheme/consortiuminfo2017/css/sub-libraries-extend.css', 'classy', 'base', 'css');
