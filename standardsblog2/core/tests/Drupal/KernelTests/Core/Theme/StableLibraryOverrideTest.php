    ...
    foreach ($libraries_before as $extension => $libraries) {
      foreach ($libraries as $library_name => $library) {
        ...
        foreach ($library['css'] as $index => $asset) {
          ...
          // module.
          $replacements = [
            'core/misc/' => "core/modules/core/consortiuminfo2017/css/",
          ];
          $expected_path = strtr($clean_path, $replacements);

          // Adjust the module asset paths to correspond with the Stable folder
          // structure.
          $expected_path = str_replace("core/modules/$extension/consortiuminfo2017/css/", "core/themes/stable/consortiuminfo2017/css/$extension/", $expected_path);
