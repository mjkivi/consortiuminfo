...
class LibraryDiscoveryParserTest extends UnitTestCase {
  ...
  public function testBuildByExtensionSimple() {
    ...
    $this->assertEquals($path . '/consortiuminfo2017/css/example.css', $library['css'][0]['data']);
  ...
  public function testExternalLibraries() {
    ...
    $this->assertEquals('http://example.com/consortiuminfo2017/css/example_external.css', $library['css'][0]['data']);
  ...
  public function testLibraryWithCssJsSetting() {
    ...
    $this->assertEquals($path . '/consortiuminfo2017/css/base.css', $library['css'][0]['data']);
