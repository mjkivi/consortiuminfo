...
class MenuLinkContentTranslationUITest extends ContentTranslationUITestBase {
  ...
  function testTranslationLinkTheme() {
    ...
    $this->assertRaw('core/themes/seven/consortiuminfo2017/css/base/elements.css', 'Edit uses admin theme.');
    $this->drupalGet('admin/structure/menu/item/' . $entityId . '/edit/translations');
    $this->assertRaw('core/themes/seven/consortiuminfo2017/css/base/elements.css', 'Translation uses admin theme as well.');
  }
