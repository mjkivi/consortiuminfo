...
class CKEditorTest extends KernelTestBase {
  ...
  function testBuildContentsCssJSSetting() {
    ...
    $editor->setSettings($settings);
    $editor->save();
    $expected[] = file_url_transform_relative(file_create_url(drupal_get_path('module', 'ckeditor_test') . '/consortiuminfo2017/css/llama.css'));
    ...
    $expected[] = file_url_transform_relative(file_create_url('core/themes/bartik/consortiuminfo2017/css/base/elements.css'));
    $expected[] = file_url_transform_relative(file_create_url('core/themes/bartik/consortiuminfo2017/css/components/captions.css'));
    $expected[] = file_url_transform_relative(file_create_url('core/themes/bartik/consortiuminfo2017/css/components/table.css'));
    $expected[] = file_url_transform_relative(file_create_url('core/themes/bartik/consortiuminfo2017/css/components/text-formatted.css'));
  ...
  protected function getDefaultContentsCssConfig() {
    return array(
      file_url_transform_relative(file_create_url('core/modules/ckeditor/consortiuminfo2017/css/ckeditor-iframe.css')),
      file_url_transform_relative(file_create_url('core/modules/system/consortiuminfo2017/css/components/align.module.css')),
    );
  }
