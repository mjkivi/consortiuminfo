...
class CKEditor extends EditorBase implements ContainerFactoryPluginInterface {
  ...
  public function buildContentsCssJSSetting(Editor $editor) {
    $css = array(
      drupal_get_path('module', 'ckeditor') . '/consortiuminfo2017/css/ckeditor-iframe.css',
      drupal_get_path('module', 'system') . '/consortiuminfo2017/css/components/align.module.css',
    );
