...
class MenuRouterTest extends WebTestBase {
  ...
  protected function doTestThemeCallbackAdministrative() {
    ...
    $this->assertRaw('seven/consortiuminfo2017/css/base/elements.css', "The administrative theme's CSS appears on the page.");
  }
  ...
  protected function doTestThemeCallbackMaintenanceMode() {
    ...
    $this->drupalGet('menu-test/theme-callback/use-admin-theme');
    $this->assertRaw('bartik/consortiuminfo2017/css/base/elements.css', "The maintenance theme's CSS appears on the page.");
  ...
  protected function doTestThemeCallbackOptionalTheme() {
    ...
    $this->assertRaw('bartik/consortiuminfo2017/css/base/elements.css', "The default theme's CSS appears on the page.");
