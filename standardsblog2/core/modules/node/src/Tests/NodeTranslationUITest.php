...
class NodeTranslationUITest extends ContentTranslationUITestBase {
  ...
  public function testTranslationLinkTheme() {
    ...
    $this->assertRaw('core/themes/seven/consortiuminfo2017/css/base/elements.css', 'Translation uses admin theme if edit is admin.');

    // Turn off admin theme for editing, assert inheritance to translations.
    $edit['use_admin_theme'] = FALSE;
    $this->drupalPostForm('admin/appearance', $edit, t('Save configuration'));
    $this->drupalGet('node/' . $article->id() . '/translations');
    $this->assertNoRaw('core/themes/seven/consortiuminfo2017/css/base/elements.css', 'Translation uses frontend theme if edit is frontend.');
