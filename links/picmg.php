<html><HEAD><TITLE>PCI Industrial Computer Manufacturers Group, Inc. (PICMG)  </TITLE>
        ...
        <table width="88%" border="1" cellspacing="0" cellpadding="0" bordercolor="#000000" align="center">
          ...
          <tr> 
            ...
            href="http://www.consortiuminfo.org">Home</a> &gt;<b> </b><a href="http://www.consortiuminfo.org/links/">Consortium 
                ...
                List</a> &gt;<strong> PCI Industrial Computer Manufacturers Group, 

                Inc. (PICMG) </strong></font></td>
...
$result = mysql_query("SELECT cons_list.cons_id, cons_list.cons_name, cons_list.cons_url  FROM cons_list WHERE cons_list.cons_id='119'", $db);
...
$result = mysql_query("SELECT cons_list.cons_id, cons_list.cons_overview  FROM cons_list  WHERE cons_list.cons_id='119'", $db);
...
$result = mysql_query("SELECT cons_list.cons_id, cons_list.cons_specs  FROM cons_list  WHERE cons_list.cons_id='119'", $db);
...
$result = mysql_query("SELECT cons_list.cons_id, cons_list.cons_ipr  FROM cons_list  WHERE cons_list.cons_id='119'", $db);
...
clear=all>
  ...
  <p> 
    ...
    <center>
      ...
      <script language="JavaScript">/* You may give each page an identifying name, server, and channel on the next lines. */var pageName = "PICMG";/**** DO NOT ALTER ANYTHING BELOW THIS LINE! ****/var code = ' '; </script>
