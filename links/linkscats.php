	...
	<a name="startcontent" id="startcontent"></a>
		...
		<div class="LinksMain">
			...
			if ($numrows > 10)
			{
				...
				// Check For M
				$queryM = "SELECT COUNT(*) AS numrows FROM ((cons_cats INNER JOIN cat_lookup on cons_cats.cat_id = cat_lookup.cat_id) INNER JOIN cons_list on cat_lookup.cons_no = cons_list.cons_id) WHERE cons_cats.cat_id='".$ID."' AND substring(cons_list.cons_name,1,1)='M' AND cons_list.published = 1";
				...
				{
					echo "<a name=\"B\"></a>";
					$result = mysql_query("SELECT cons_list.cons_id, cons_list.cons_name, cons_list.link_url, cons_list.link_desc, cons_cats.cat_id, cat_lookup.cat_id, cat_lookup.cons_no  FROM ((cons_cats INNER JOIN cat_lookup on cons_cats.cat_id = cat_lookup.cat_id) INNER JOIN cons_list on cat_lookup.cons_no = cons_list.cons_id) WHERE cons_cats.cat_id='".$ID."' AND substring(cons_list.cons_name,1,1)='B' AND cons_list.published = 1 ORDER BY cons_name ASC", $db);
					while ($myrow = mysql_fetch_array($result))
					{
						echo "<p><strong><a href=\"linksdetail.php?ID=".$myrow["cons_no"]."&ReturnID=".$ID."&Category=".$Category."&SubCat=".str_replace('&', '%26', $SubCat)."\">".str_replace($oldchars, $newchars, $myrow["cons_name"])."</a></strong><br />";
						echo str_replace($oldchars, $newchars, $myrow["link_desc"])."</p>\n";
				...
				{
					echo "<a name=\"C\"></a>";
					$result = mysql_query("SELECT cons_list.cons_id, cons_list.cons_name, cons_list.link_url, cons_list.link_desc, cons_cats.cat_id, cat_lookup.cat_id, cat_lookup.cons_no  FROM ((cons_cats INNER JOIN cat_lookup on cons_cats.cat_id = cat_lookup.cat_id) INNER JOIN cons_list on cat_lookup.cons_no = cons_list.cons_id) WHERE cons_cats.cat_id='".$ID."' AND substring(cons_list.cons_name,1,1)='C' AND cons_list.published = 1 ORDER BY cons_name ASC", $db);
					while ($myrow = mysql_fetch_array($result))
					{
						echo "<p><strong><a href=\"linksdetail.php?ID=".$myrow["cons_no"]."&ReturnID=".$ID."&Category=".$Category."&SubCat=".str_replace('&', '%26', $SubCat)."\">".str_replace($oldchars, $newchars, $myrow["cons_name"])."</a></strong><br />";
						echo str_replace($oldchars, $newchars, $myrow["link_desc"])."</p>\n";
				...
				{
					echo "<a name=\"D\"></a>";
					$result = mysql_query("SELECT cons_list.cons_id, cons_list.cons_name, cons_list.link_url, cons_list.link_desc, cons_cats.cat_id, cat_lookup.cat_id, cat_lookup.cons_no  FROM ((cons_cats INNER JOIN cat_lookup on cons_cats.cat_id = cat_lookup.cat_id) INNER JOIN cons_list on cat_lookup.cons_no = cons_list.cons_id) WHERE cons_cats.cat_id='".$ID."' AND substring(cons_list.cons_name,1,1)='D' AND cons_list.published = 1 ORDER BY cons_name ASC", $db);
					while ($myrow = mysql_fetch_array($result))
					{
						echo "<p><strong><a href=\"linksdetail.php?ID=".$myrow["cons_no"]."&ReturnID=".$ID."&Category=".$Category."&SubCat=".str_replace('&', '%26', $SubCat)."\">".str_replace($oldchars, $newchars, $myrow["cons_name"])."</a></strong><br />";
						echo str_replace($oldchars, $newchars, $myrow["link_desc"])."</p>\n";
				...
				{
					echo "<a name=\"E\"></a>";
					$result = mysql_query("SELECT cons_list.cons_id, cons_list.cons_name, cons_list.link_url, cons_list.link_desc, cons_cats.cat_id, cat_lookup.cat_id, cat_lookup.cons_no  FROM ((cons_cats INNER JOIN cat_lookup on cons_cats.cat_id = cat_lookup.cat_id) INNER JOIN cons_list on cat_lookup.cons_no = cons_list.cons_id) WHERE cons_cats.cat_id='".$ID."' AND substring(cons_list.cons_name,1,1)='E' AND cons_list.published = 1 ORDER BY cons_name ASC", $db);
					while ($myrow = mysql_fetch_array($result))
					{
						echo "<p><strong><a href=\"linksdetail.php?ID=".$myrow["cons_no"]."&ReturnID=".$ID."&Category=".$Category."&SubCat=".str_replace('&', '%26', $SubCat)."\">".str_replace($oldchars, $newchars, $myrow["cons_name"])."</a></strong><br />";
						echo str_replace($oldchars, $newchars, $myrow["link_desc"])."</p>\n";
				...
				{
					echo "<a name=\"F\"></a>";
					$result = mysql_query("SELECT cons_list.cons_id, cons_list.cons_name, cons_list.link_url, cons_list.link_desc, cons_cats.cat_id, cat_lookup.cat_id, cat_lookup.cons_no  FROM ((cons_cats INNER JOIN cat_lookup on cons_cats.cat_id = cat_lookup.cat_id) INNER JOIN cons_list on cat_lookup.cons_no = cons_list.cons_id) WHERE cons_cats.cat_id='".$ID."' AND substring(cons_list.cons_name,1,1)='F' AND cons_list.published = 1 ORDER BY cons_name ASC", $db);
					while ($myrow = mysql_fetch_array($result))
					{
						echo "<p><strong><a href=\"linksdetail.php?ID=".$myrow["cons_no"]."&ReturnID=".$ID."&Category=".$Category."&SubCat=".str_replace('&', '%26', $SubCat)."\">".str_replace($oldchars, $newchars, $myrow["cons_name"])."</a></strong><br />";
						echo str_replace($oldchars, $newchars, $myrow["link_desc"])."</p>\n";
				...
				{
					echo "<a name=\"G\"></a>";
					$result = mysql_query("SELECT cons_list.cons_id, cons_list.cons_name, cons_list.link_url, cons_list.link_desc, cons_cats.cat_id, cat_lookup.cat_id, cat_lookup.cons_no  FROM ((cons_cats INNER JOIN cat_lookup on cons_cats.cat_id = cat_lookup.cat_id) INNER JOIN cons_list on cat_lookup.cons_no = cons_list.cons_id) WHERE cons_cats.cat_id='".$ID."' AND substring(cons_list.cons_name,1,1)='G' AND cons_list.published = 1 ORDER BY cons_name ASC", $db);
					while ($myrow = mysql_fetch_array($result))
					{
						echo "<p><strong><a href=\"linksdetail.php?ID=".$myrow["cons_no"]."&ReturnID=".$ID."&Category=".$Category."&SubCat=".str_replace('&', '%26', $SubCat)."\">".str_replace($oldchars, $newchars, $myrow["cons_name"])."</a></strong><br />";
						echo str_replace($oldchars, $newchars, $myrow["link_desc"])."</p>\n";
				...
				{
					echo "<a name=\"H\"></a>";
					$result = mysql_query("SELECT cons_list.cons_id, cons_list.cons_name, cons_list.link_url, cons_list.link_desc, cons_cats.cat_id, cat_lookup.cat_id, cat_lookup.cons_no  FROM ((cons_cats INNER JOIN cat_lookup on cons_cats.cat_id = cat_lookup.cat_id) INNER JOIN cons_list on cat_lookup.cons_no = cons_list.cons_id) WHERE cons_cats.cat_id='".$ID."' AND substring(cons_list.cons_name,1,1)='H' AND cons_list.published = 1 ORDER BY cons_name ASC", $db);
					while ($myrow = mysql_fetch_array($result))
					{
						echo "<p><strong><a href=\"linksdetail.php?ID=".$myrow["cons_no"]."&ReturnID=".$ID."&Category=".$Category."&SubCat=".str_replace('&', '%26', $SubCat)."\">".str_replace($oldchars, $newchars, $myrow["cons_name"])."</a></strong><br />";
						echo str_replace($oldchars, $newchars, $myrow["link_desc"])."</p>\n";
				...
				{
					echo "<a name=\"I\"></a>";
					$result = mysql_query("SELECT cons_list.cons_id, cons_list.cons_name, cons_list.link_url, cons_list.link_desc, cons_cats.cat_id, cat_lookup.cat_id, cat_lookup.cons_no  FROM ((cons_cats INNER JOIN cat_lookup on cons_cats.cat_id = cat_lookup.cat_id) INNER JOIN cons_list on cat_lookup.cons_no = cons_list.cons_id) WHERE cons_cats.cat_id='".$ID."' AND substring(cons_list.cons_name,1,1)='I' AND cons_list.published = 1 ORDER BY cons_name ASC", $db);
					while ($myrow = mysql_fetch_array($result))
					{
						echo "<p><strong><a href=\"linksdetail.php?ID=".$myrow["cons_no"]."&ReturnID=".$ID."&Category=".$Category."&SubCat=".str_replace('&', '%26', $SubCat)."\">".str_replace($oldchars, $newchars, $myrow["cons_name"])."</a></strong><br />";
						echo str_replace($oldchars, $newchars, $myrow["link_desc"])."</p>\n";
				...
				{
					echo "<a name=\"J\"></a>";
					$result = mysql_query("SELECT cons_list.cons_id, cons_list.cons_name, cons_list.link_url, cons_list.link_desc, cons_cats.cat_id, cat_lookup.cat_id, cat_lookup.cons_no  FROM ((cons_cats INNER JOIN cat_lookup on cons_cats.cat_id = cat_lookup.cat_id) INNER JOIN cons_list on cat_lookup.cons_no = cons_list.cons_id) WHERE cons_cats.cat_id='".$ID."' AND substring(cons_list.cons_name,1,1)='J' AND cons_list.published = 1 ORDER BY cons_name ASC", $db);
					while ($myrow = mysql_fetch_array($result))
					{
						echo "<p><strong><a href=\"linksdetail.php?ID=".$myrow["cons_no"]."&ReturnID=".$ID."&Category=".$Category."&SubCat=".str_replace('&', '%26', $SubCat)."\">".str_replace($oldchars, $newchars, $myrow["cons_name"])."</a></strong><br />";
						echo str_replace($oldchars, $newchars, $myrow["link_desc"])."</p>\n";
				...
				{
					echo "<a name=\"K\"></a>";
					$result = mysql_query("SELECT cons_list.cons_id, cons_list.cons_name, cons_list.link_url, cons_list.link_desc, cons_cats.cat_id, cat_lookup.cat_id, cat_lookup.cons_no  FROM ((cons_cats INNER JOIN cat_lookup on cons_cats.cat_id = cat_lookup.cat_id) INNER JOIN cons_list on cat_lookup.cons_no = cons_list.cons_id) WHERE cons_cats.cat_id='".$ID."' AND substring(cons_list.cons_name,1,1)='K' AND cons_list.published = 1 ORDER BY cons_name ASC", $db);
					while ($myrow = mysql_fetch_array($result))
					{
						echo "<p><strong><a href=\"linksdetail.php?ID=".$myrow["cons_no"]."&ReturnID=".$ID."&Category=".$Category."&SubCat=".str_replace('&', '%26', $SubCat)."\">".str_replace($oldchars, $newchars, $myrow["cons_name"])."</a></strong><br />";
						echo str_replace($oldchars, $newchars, $myrow["link_desc"])."</p>\n";
				...
				{
					echo "<a name=\"L\"></a>";
					$result = mysql_query("SELECT cons_list.cons_id, cons_list.cons_name, cons_list.link_url, cons_list.link_desc, cons_cats.cat_id, cat_lookup.cat_id, cat_lookup.cons_no  FROM ((cons_cats INNER JOIN cat_lookup on cons_cats.cat_id = cat_lookup.cat_id) INNER JOIN cons_list on cat_lookup.cons_no = cons_list.cons_id) WHERE cons_cats.cat_id='".$ID."' AND substring(cons_list.cons_name,1,1)='L' AND cons_list.published = 1 ORDER BY cons_name ASC", $db);
					while ($myrow = mysql_fetch_array($result))
					{
						echo "<p><strong><a href=\"linksdetail.php?ID=".$myrow["cons_no"]."&ReturnID=".$ID."&Category=".$Category."&SubCat=".str_replace('&', '%26', $SubCat)."\">".str_replace($oldchars, $newchars, $myrow["cons_name"])."</a></strong><br />";
						echo str_replace($oldchars, $newchars, $myrow["link_desc"])."</p>\n";
				...
				{
					echo "<a name=\"M\"></a>";
					$result = mysql_query("SELECT cons_list.cons_id, cons_list.cons_name, cons_list.link_url, cons_list.link_desc, cons_cats.cat_id, cat_lookup.cat_id, cat_lookup.cons_no  FROM ((cons_cats INNER JOIN cat_lookup on cons_cats.cat_id = cat_lookup.cat_id) INNER JOIN cons_list on cat_lookup.cons_no = cons_list.cons_id) WHERE cons_cats.cat_id='".$ID."' AND substring(cons_list.cons_name,1,1)='M' AND cons_list.published = 1 ORDER BY cons_name ASC", $db);
					while ($myrow = mysql_fetch_array($result))
					{
						echo "<p><strong><a href=\"linksdetail.php?ID=".$myrow["cons_no"]."&ReturnID=".$ID."&Category=".$Category."&SubCat=".str_replace('&', '%26', $SubCat)."\">".str_replace($oldchars, $newchars, $myrow["cons_name"])."</a></strong><br />";
						echo str_replace($oldchars, $newchars, $myrow["link_desc"])."</p>\n";
				...
				{
					echo "<a name=\"N\"></a>";
					$result = mysql_query("SELECT cons_list.cons_id, cons_list.cons_name, cons_list.link_url, cons_list.link_desc, cons_cats.cat_id, cat_lookup.cat_id, cat_lookup.cons_no  FROM ((cons_cats INNER JOIN cat_lookup on cons_cats.cat_id = cat_lookup.cat_id) INNER JOIN cons_list on cat_lookup.cons_no = cons_list.cons_id) WHERE cons_cats.cat_id='".$ID."' AND substring(cons_list.cons_name,1,1)='N' AND cons_list.published = 1 ORDER BY cons_name ASC", $db);
					while ($myrow = mysql_fetch_array($result))
					{
						echo "<p><strong><a href=\"linksdetail.php?ID=".$myrow["cons_no"]."&ReturnID=".$ID."&Category=".$Category."&SubCat=".str_replace('&', '%26', $SubCat)."\">".str_replace($oldchars, $newchars, $myrow["cons_name"])."</a></strong><br />";
						echo str_replace($oldchars, $newchars, $myrow["link_desc"])."</p>\n";
				...
				{
					echo "<a name=\"O\"></a>";
					$result = mysql_query("SELECT cons_list.cons_id, cons_list.cons_name, cons_list.link_url, cons_list.link_desc, cons_cats.cat_id, cat_lookup.cat_id, cat_lookup.cons_no  FROM ((cons_cats INNER JOIN cat_lookup on cons_cats.cat_id = cat_lookup.cat_id) INNER JOIN cons_list on cat_lookup.cons_no = cons_list.cons_id) WHERE cons_cats.cat_id='".$ID."' AND substring(cons_list.cons_name,1,1)='O' AND cons_list.published = 1 ORDER BY cons_name ASC", $db);
					while ($myrow = mysql_fetch_array($result))
					{
						echo "<p><strong><a href=\"linksdetail.php?ID=".$myrow["cons_no"]."&ReturnID=".$ID."&Category=".$Category."&SubCat=".str_replace('&', '%26', $SubCat)."\">".str_replace($oldchars, $newchars, $myrow["cons_name"])."</a></strong><br />";
						echo str_replace($oldchars, $newchars, $myrow["link_desc"])."</p>\n";
				...
				{
					echo "<a name=\"P\"></a>";
					$result = mysql_query("SELECT cons_list.cons_id, cons_list.cons_name, cons_list.link_url, cons_list.link_desc, cons_cats.cat_id, cat_lookup.cat_id, cat_lookup.cons_no  FROM ((cons_cats INNER JOIN cat_lookup on cons_cats.cat_id = cat_lookup.cat_id) INNER JOIN cons_list on cat_lookup.cons_no = cons_list.cons_id) WHERE cons_cats.cat_id='".$ID."' AND substring(cons_list.cons_name,1,1)='P' AND cons_list.published = 1 ORDER BY cons_name ASC", $db);
					while ($myrow = mysql_fetch_array($result))
					{
						echo "<p><strong><a href=\"linksdetail.php?ID=".$myrow["cons_no"]."&ReturnID=".$ID."&Category=".$Category."&SubCat=".str_replace('&', '%26', $SubCat)."\">".str_replace($oldchars, $newchars, $myrow["cons_name"])."</a></strong><br />";
						echo str_replace($oldchars, $newchars, $myrow["link_desc"])."</p>\n";
				...
				{
					echo "<a name=\"Q\"></a>";
					$result = mysql_query("SELECT cons_list.cons_id, cons_list.cons_name, cons_list.link_url, cons_list.link_desc, cons_cats.cat_id, cat_lookup.cat_id, cat_lookup.cons_no  FROM ((cons_cats INNER JOIN cat_lookup on cons_cats.cat_id = cat_lookup.cat_id) INNER JOIN cons_list on cat_lookup.cons_no = cons_list.cons_id) WHERE cons_cats.cat_id='".$ID."' AND substring(cons_list.cons_name,1,1)='Q' AND cons_list.published = 1 ORDER BY cons_name ASC", $db);
					while ($myrow = mysql_fetch_array($result))
					{
						echo "<p><strong><a href=\"linksdetail.php?ID=".$myrow["cons_no"]."&ReturnID=".$ID."&Category=".$Category."&SubCat=".str_replace('&', '%26', $SubCat)."\">".str_replace($oldchars, $newchars, $myrow["cons_name"])."</a></strong><br />";
						echo str_replace($oldchars, $newchars, $myrow["link_desc"])."</p>\n";
				...
				{
					echo "<a name=\"R\"></a>";
					$result = mysql_query("SELECT cons_list.cons_id, cons_list.cons_name, cons_list.link_url, cons_list.link_desc, cons_cats.cat_id, cat_lookup.cat_id, cat_lookup.cons_no  FROM ((cons_cats INNER JOIN cat_lookup on cons_cats.cat_id = cat_lookup.cat_id) INNER JOIN cons_list on cat_lookup.cons_no = cons_list.cons_id) WHERE cons_cats.cat_id='".$ID."' AND substring(cons_list.cons_name,1,1)='R' AND cons_list.published = 1 ORDER BY cons_name ASC", $db);
					while ($myrow = mysql_fetch_array($result))
					{
						echo "<p><strong><a href=\"linksdetail.php?ID=".$myrow["cons_no"]."&ReturnID=".$ID."&Category=".$Category."&SubCat=".str_replace('&', '%26', $SubCat)."\">".str_replace($oldchars, $newchars, $myrow["cons_name"])."</a></strong><br />";
						echo str_replace($oldchars, $newchars, $myrow["link_desc"])."</p>\n";
				...
				{
					echo "<a name=\"S\"></a>";
					$result = mysql_query("SELECT cons_list.cons_id, cons_list.cons_name, cons_list.link_url, cons_list.link_desc, cons_cats.cat_id, cat_lookup.cat_id, cat_lookup.cons_no  FROM ((cons_cats INNER JOIN cat_lookup on cons_cats.cat_id = cat_lookup.cat_id) INNER JOIN cons_list on cat_lookup.cons_no = cons_list.cons_id) WHERE cons_cats.cat_id='".$ID."' AND substring(cons_list.cons_name,1,1)='S' AND cons_list.published = 1 ORDER BY cons_name ASC", $db);
					while ($myrow = mysql_fetch_array($result))
					{
						echo "<p><strong><a href=\"linksdetail.php?ID=".$myrow["cons_no"]."&ReturnID=".$ID."&Category=".$Category."&SubCat=".str_replace('&', '%26', $SubCat)."\">".str_replace($oldchars, $newchars, $myrow["cons_name"])."</a></strong><br />";
						echo str_replace($oldchars, $newchars, $myrow["link_desc"])."</p>\n";
				...
				{
					echo "<a name=\"T\"></a>";
					$result = mysql_query("SELECT cons_list.cons_id, cons_list.cons_name, cons_list.link_url, cons_list.link_desc, cons_cats.cat_id, cat_lookup.cat_id, cat_lookup.cons_no  FROM ((cons_cats INNER JOIN cat_lookup on cons_cats.cat_id = cat_lookup.cat_id) INNER JOIN cons_list on cat_lookup.cons_no = cons_list.cons_id) WHERE cons_cats.cat_id='".$ID."' AND substring(cons_list.cons_name,1,1)='T' AND cons_list.published = 1 ORDER BY cons_name ASC", $db);
					while ($myrow = mysql_fetch_array($result))
					{
						echo "<p><strong><a href=\"linksdetail.php?ID=".$myrow["cons_no"]."&ReturnID=".$ID."&Category=".$Category."&SubCat=".str_replace('&', '%26', $SubCat)."\">".str_replace($oldchars, $newchars, $myrow["cons_name"])."</a></strong><br />";
						echo str_replace($oldchars, $newchars, $myrow["link_desc"])."</p>\n";
				...
				{
					echo "<a name=\"U\"></a>";
					$result = mysql_query("SELECT cons_list.cons_id, cons_list.cons_name, cons_list.link_url, cons_list.link_desc, cons_cats.cat_id, cat_lookup.cat_id, cat_lookup.cons_no  FROM ((cons_cats INNER JOIN cat_lookup on cons_cats.cat_id = cat_lookup.cat_id) INNER JOIN cons_list on cat_lookup.cons_no = cons_list.cons_id) WHERE cons_cats.cat_id='".$ID."' AND substring(cons_list.cons_name,1,1)='U' AND cons_list.published = 1 ORDER BY cons_name ASC", $db);
					while ($myrow = mysql_fetch_array($result))
					{
						echo "<p><strong><a href=\"linksdetail.php?ID=".$myrow["cons_no"]."&ReturnID=".$ID."&Category=".$Category."&SubCat=".str_replace('&', '%26', $SubCat)."\">".str_replace($oldchars, $newchars, $myrow["cons_name"])."</a></strong><br />";
						echo str_replace($oldchars, $newchars, $myrow["link_desc"])."</p>\n";
				...
				{
					echo "<a name=\"V\"></a>";
					$result = mysql_query("SELECT cons_list.cons_id, cons_list.cons_name, cons_list.link_url, cons_list.link_desc, cons_cats.cat_id, cat_lookup.cat_id, cat_lookup.cons_no  FROM ((cons_cats INNER JOIN cat_lookup on cons_cats.cat_id = cat_lookup.cat_id) INNER JOIN cons_list on cat_lookup.cons_no = cons_list.cons_id) WHERE cons_cats.cat_id='".$ID."' AND substring(cons_list.cons_name,1,1)='V' AND cons_list.published = 1 ORDER BY cons_name ASC", $db);
					while ($myrow = mysql_fetch_array($result))
					{
						echo "<p><strong><a href=\"linksdetail.php?ID=".$myrow["cons_no"]."&ReturnID=".$ID."&Category=".$Category."&SubCat=".str_replace('&', '%26', $SubCat)."\">".str_replace($oldchars, $newchars, $myrow["cons_name"])."</a></strong><br />";
						echo str_replace($oldchars, $newchars, $myrow["link_desc"])."</p>\n";
				...
				{
					echo "<a name=\"W\"></a>";
					$result = mysql_query("SELECT cons_list.cons_id, cons_list.cons_name, cons_list.link_url, cons_list.link_desc, cons_cats.cat_id, cat_lookup.cat_id, cat_lookup.cons_no  FROM ((cons_cats INNER JOIN cat_lookup on cons_cats.cat_id = cat_lookup.cat_id) INNER JOIN cons_list on cat_lookup.cons_no = cons_list.cons_id) WHERE cons_cats.cat_id='".$ID."' AND substring(cons_list.cons_name,1,1)='W' AND cons_list.published = 1 ORDER BY cons_name ASC", $db);
					while ($myrow = mysql_fetch_array($result))
					{
						echo "<p><strong><a href=\"linksdetail.php?ID=".$myrow["cons_no"]."&ReturnID=".$ID."&Category=".$Category."&SubCat=".str_replace('&', '%26', $SubCat)."\">".str_replace($oldchars, $newchars, $myrow["cons_name"])."</a></strong><br />";
						echo str_replace($oldchars, $newchars, $myrow["link_desc"])."</p>\n";
				...
				{
					echo "<a name=\"X\"></a>";
					$result = mysql_query("SELECT cons_list.cons_id, cons_list.cons_name, cons_list.link_url, cons_list.link_desc, cons_cats.cat_id, cat_lookup.cat_id, cat_lookup.cons_no  FROM ((cons_cats INNER JOIN cat_lookup on cons_cats.cat_id = cat_lookup.cat_id) INNER JOIN cons_list on cat_lookup.cons_no = cons_list.cons_id) WHERE cons_cats.cat_id='".$ID."' AND substring(cons_list.cons_name,1,1)='X' AND cons_list.published = 1 ORDER BY cons_name ASC", $db);
					while ($myrow = mysql_fetch_array($result))
					{
						echo "<p><strong><a href=\"linksdetail.php?ID=".$myrow["cons_no"]."&ReturnID=".$ID."&Category=".$Category."&SubCat=".str_replace('&', '%26', $SubCat)."\">".str_replace($oldchars, $newchars, $myrow["cons_name"])."</a></strong><br />";
						echo str_replace($oldchars, $newchars, $myrow["link_desc"])."</p>\n";
				...
				{
					echo "<a name=\"Y\"></a>";
					$result = mysql_query("SELECT cons_list.cons_id, cons_list.cons_name, cons_list.link_url, cons_list.link_desc, cons_cats.cat_id, cat_lookup.cat_id, cat_lookup.cons_no  FROM ((cons_cats INNER JOIN cat_lookup on cons_cats.cat_id = cat_lookup.cat_id) INNER JOIN cons_list on cat_lookup.cons_no = cons_list.cons_id) WHERE cons_cats.cat_id='".$ID."' AND substring(cons_list.cons_name,1,1)='Y' AND cons_list.published = 1 ORDER BY cons_name ASC", $db);
					while ($myrow = mysql_fetch_array($result))
					{
						echo "<p><strong><a href=\"linksdetail.php?ID=".$myrow["cons_no"]."&ReturnID=".$ID."&Category=".$Category."&SubCat=".str_replace('&', '%26', $SubCat)."\">".str_replace($oldchars, $newchars, $myrow["cons_name"])."</a></strong><br />";
						echo str_replace($oldchars, $newchars, $myrow["link_desc"])."</p>\n";
				...
				{
					echo "<a name=\"Z\"></a>";
					$result = mysql_query("SELECT cons_list.cons_id, cons_list.cons_name, cons_list.link_url, cons_list.link_desc, cons_cats.cat_id, cat_lookup.cat_id, cat_lookup.cons_no  FROM ((cons_cats INNER JOIN cat_lookup on cons_cats.cat_id = cat_lookup.cat_id) INNER JOIN cons_list on cat_lookup.cons_no = cons_list.cons_id) WHERE cons_cats.cat_id='".$ID."' AND substring(cons_list.cons_name,1,1)='Z' AND cons_list.published = 1 ORDER BY cons_name ASC", $db);
					while ($myrow = mysql_fetch_array($result))
					{
						echo "<p><strong><a href=\"linksdetail.php?ID=".$myrow["cons_no"]."&ReturnID=".$ID."&Category=".$Category."&SubCat=".str_replace('&', '%26', $SubCat)."\">".str_replace($oldchars, $newchars, $myrow["cons_name"])."</a></strong><br />";
						echo str_replace($oldchars, $newchars, $myrow["link_desc"])."</p>\n";
			...
			if ($numrows <= 10)
			{
				$result = mysql_query("SELECT cons_list.cons_id, cons_list.cons_name, cons_list.link_url, cons_list.link_desc, cons_cats.cat_id, cat_lookup.cat_id, cat_lookup.cons_no  FROM ((cons_cats INNER JOIN cat_lookup on cons_cats.cat_id = cat_lookup.cat_id) INNER JOIN cons_list on cat_lookup.cons_no = cons_list.cons_id) WHERE cons_cats.cat_id='".$ID."' AND cons_list.published = 1 ORDER BY cons_name ASC", $db);
				while ($myrow = mysql_fetch_array($result))
				{
					echo "<p><strong><a href=\"linksdetail.php?ID=".$myrow["cons_no"]."&ReturnID=".$ID."&Category=".$Category."&SubCat=".str_replace('&', '%26', $SubCat)."\">".str_replace($oldchars, $newchars, $myrow["cons_name"])."</a></strong><br />";
					echo str_replace($oldchars, $newchars, $myrow["link_desc"])."</p>\n";
