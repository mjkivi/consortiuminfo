	...
	<a name="startcontent" id="startcontent"></a>
		...
		<div class="LinksMain">
			...
			if ($numrows > 10)
			{
				...
				{
					echo "<a name=\"A\"></a>";
					$result = mysql_query("SELECT * FROM cons_list WHERE substring(cons_list.cons_name,1,1)<'A' ORDER BY cons_name ASC", $db);
					while ($myrow = mysql_fetch_array($result))
					{
						echo "<p><strong><a href=\"linksdetail2.php?ID=".$myrow["cons_id"]."\">".str_replace($oldchars, $newchars, $myrow["cons_name"])."</a></strong><br />";
				...
				{
					echo "<a name=\"B\"></a>";
					$result = mysql_query("SELECT * FROM cons_list WHERE substring(cons_list.cons_name,1,1)='B' ORDER BY cons_name ASC", $db);
					while ($myrow = mysql_fetch_array($result))
					{
						echo "<p><strong><a href=\"linksdetail2.php?ID=".$myrow["cons_id"]."\">".str_replace($oldchars, $newchars, $myrow["cons_name"])."</a></strong><br />";
						echo str_replace($oldchars, $newchars, $myrow["link_desc"])."</p>\n";
				...
				{
					echo "<a name=\"C\"></a>";
					$result = mysql_query("SELECT * FROM cons_list WHERE substring(cons_list.cons_name,1,1)='C' ORDER BY cons_name ASC", $db);
					while ($myrow = mysql_fetch_array($result))
					{
						echo "<p><strong><a href=\"linksdetail2.php?ID=".$myrow["cons_id"]."\">".str_replace($oldchars, $newchars, $myrow["cons_name"])."</a></strong><br />";
						echo str_replace($oldchars, $newchars, $myrow["link_desc"])."</p>\n";
				...
				{
					echo "<a name=\"D\"></a>";
					$result = mysql_query("SELECT * FROM cons_list WHERE substring(cons_list.cons_name,1,1)='D' ORDER BY cons_name ASC", $db);
					while ($myrow = mysql_fetch_array($result))
					{
						echo "<p><strong><a href=\"linksdetail2.php?ID=".$myrow["cons_id"]."\">".str_replace($oldchars, $newchars, $myrow["cons_name"])."</a></strong><br />";
						echo str_replace($oldchars, $newchars, $myrow["link_desc"])."</p>\n";
				...
				{
					echo "<a name=\"E\"></a>";
					$result = mysql_query("SELECT * FROM cons_list WHERE substring(cons_list.cons_name,1,1)='E' ORDER BY cons_name ASC", $db);
					while ($myrow = mysql_fetch_array($result))
					{
						echo "<p><strong><a href=\"linksdetail2.php?ID=".$myrow["cons_id"]."\">".str_replace($oldchars, $newchars, $myrow["cons_name"])."</a></strong><br />";
						echo str_replace($oldchars, $newchars, $myrow["link_desc"])."</p>\n";
				...
				{
					echo "<a name=\"F\"></a>";
					$result = mysql_query("SELECT * FROM cons_list WHERE substring(cons_list.cons_name,1,1)='F' ORDER BY cons_name ASC", $db);
					while ($myrow = mysql_fetch_array($result))
					{
						echo "<p><strong><a href=\"linksdetail2.php?ID=".$myrow["cons_id"]."\">".str_replace($oldchars, $newchars, $myrow["cons_name"])."</a></strong><br />";
						echo str_replace($oldchars, $newchars, $myrow["link_desc"])."</p>\n";
				...
				{
					echo "<a name=\"G\"></a>";
					$result = mysql_query("SELECT * FROM cons_list WHERE substring(cons_list.cons_name,1,1)='G' ORDER BY cons_name ASC", $db);
					while ($myrow = mysql_fetch_array($result))
					{
						echo "<p><strong><a href=\"linksdetail2.php?ID=".$myrow["cons_id"]."\">".str_replace($oldchars, $newchars, $myrow["cons_name"])."</a></strong><br />";
						echo str_replace($oldchars, $newchars, $myrow["link_desc"])."</p>\n";
				...
				{
					echo "<a name=\"H\"></a>";
					$result = mysql_query("SELECT * FROM cons_list WHERE substring(cons_list.cons_name,1,1)='H' ORDER BY cons_name ASC", $db);
					while ($myrow = mysql_fetch_array($result))
					{
						echo "<p><strong><a href=\"linksdetail2.php?ID=".$myrow["cons_id"]."\">".str_replace($oldchars, $newchars, $myrow["cons_name"])."</a></strong><br />";
						echo str_replace($oldchars, $newchars, $myrow["link_desc"])."</p>\n";
				...
				{
					echo "<a name=\"I\"></a>";
					$result = mysql_query("SELECT * FROM cons_list WHERE substring(cons_list.cons_name,1,1)='I' ORDER BY cons_name ASC", $db);
					while ($myrow = mysql_fetch_array($result))
					{
						echo "<p><strong><a href=\"linksdetail2.php?ID=".$myrow["cons_id"]."\">".str_replace($oldchars, $newchars, $myrow["cons_name"])."</a></strong><br />";
						echo str_replace($oldchars, $newchars, $myrow["link_desc"])."</p>\n";
				...
				{
					echo "<a name=\"J\"></a>";
					$result = mysql_query("SELECT * FROM cons_list WHERE substring(cons_list.cons_name,1,1)='J' ORDER BY cons_name ASC", $db);
					while ($myrow = mysql_fetch_array($result))
					{
						echo "<p><strong><a href=\"linksdetail2.php?ID=".$myrow["cons_id"]."\">".str_replace($oldchars, $newchars, $myrow["cons_name"])."</a></strong><br />";
						echo str_replace($oldchars, $newchars, $myrow["link_desc"])."</p>\n";
				...
				{
					echo "<a name=\"K\"></a>";
					$result = mysql_query("SELECT * FROM cons_list WHERE substring(cons_list.cons_name,1,1)='K' ORDER BY cons_name ASC", $db);
					while ($myrow = mysql_fetch_array($result))
					{
						echo "<p><strong><a href=\"linksdetail2.php?ID=".$myrow["cons_id"]."\">".str_replace($oldchars, $newchars, $myrow["cons_name"])."</a></strong><br />";
						echo str_replace($oldchars, $newchars, $myrow["link_desc"])."</p>\n";
				...
				{
					echo "<a name=\"L\"></a>";
					$result = mysql_query("SELECT * FROM cons_list WHERE substring(cons_list.cons_name,1,1)='L' ORDER BY cons_name ASC", $db);
					while ($myrow = mysql_fetch_array($result))
					{
						echo "<p><strong><a href=\"linksdetail2.php?ID=".$myrow["cons_id"]."\">".str_replace($oldchars, $newchars, $myrow["cons_name"])."</a></strong><br />";
						echo str_replace($oldchars, $newchars, $myrow["link_desc"])."</p>\n";
				...
				{
					echo "<a name=\"M\"></a>";
					$result = mysql_query("SELECT * FROM cons_list WHERE substring(cons_list.cons_name,1,1)='M' ORDER BY cons_name ASC", $db);
					while ($myrow = mysql_fetch_array($result))
					{
						echo "<p><strong><a href=\"linksdetail2.php?ID=".$myrow["cons_id"]."\">".str_replace($oldchars, $newchars, $myrow["cons_name"])."</a></strong><br />";
						echo str_replace($oldchars, $newchars, $myrow["link_desc"])."</p>\n";
				...
				{
					echo "<a name=\"N\"></a>";
					$result = mysql_query("SELECT * FROM cons_list WHERE substring(cons_list.cons_name,1,1)='N' ORDER BY cons_name ASC", $db);
					while ($myrow = mysql_fetch_array($result))
					{
						echo "<p><strong><a href=\"linksdetail2.php?ID=".$myrow["cons_id"]."\">".str_replace($oldchars, $newchars, $myrow["cons_name"])."</a></strong><br />";
						echo str_replace($oldchars, $newchars, $myrow["link_desc"])."</p>\n";
				...
				{
					echo "<a name=\"O\"></a>";
					$result = mysql_query("SELECT * FROM cons_list WHERE substring(cons_list.cons_name,1,1)='O' ORDER BY cons_name ASC", $db);
					while ($myrow = mysql_fetch_array($result))
					{
						echo "<p><strong><a href=\"linksdetail2.php?ID=".$myrow["cons_id"]."\">".str_replace($oldchars, $newchars, $myrow["cons_name"])."</a></strong><br />";
						echo str_replace($oldchars, $newchars, $myrow["link_desc"])."</p>\n";
				...
				{
					echo "<a name=\"P\"></a>";
					$result = mysql_query("SELECT * FROM cons_list WHERE substring(cons_list.cons_name,1,1)='P' ORDER BY cons_name ASC", $db);
					while ($myrow = mysql_fetch_array($result))
					{
						echo "<p><strong><a href=\"linksdetail2.php?ID=".$myrow["cons_id"]."\">".str_replace($oldchars, $newchars, $myrow["cons_name"])."</a></strong><br />";
						echo str_replace($oldchars, $newchars, $myrow["link_desc"])."</p>\n";
				...
				{
					echo "<a name=\"Q\"></a>";
					$result = mysql_query("SELECT * FROM cons_list WHERE substring(cons_list.cons_name,1,1)='Q' ORDER BY cons_name ASC", $db);
					while ($myrow = mysql_fetch_array($result))
					{
						echo "<p><strong><a href=\"linksdetail2.php?ID=".$myrow["cons_id"]."\">".str_replace($oldchars, $newchars, $myrow["cons_name"])."</a></strong><br />";
						echo str_replace($oldchars, $newchars, $myrow["link_desc"])."</p>\n";
				...
				{
					echo "<a name=\"R\"></a>";
					$result = mysql_query("SELECT * FROM cons_list WHERE substring(cons_list.cons_name,1,1)='R' ORDER BY cons_name ASC", $db);
					while ($myrow = mysql_fetch_array($result))
					{
						echo "<p><strong><a href=\"linksdetail2.php?ID=".$myrow["cons_id"]."\">".str_replace($oldchars, $newchars, $myrow["cons_name"])."</a></strong><br />";
						echo str_replace($oldchars, $newchars, $myrow["link_desc"])."</p>\n";
				...
				{
					echo "<a name=\"S\"></a>";
					$result = mysql_query("SELECT * FROM cons_list WHERE substring(cons_list.cons_name,1,1)='S' ORDER BY cons_name ASC", $db);
					while ($myrow = mysql_fetch_array($result))
					{
						echo "<p><strong><a href=\"linksdetail2.php?ID=".$myrow["cons_id"]."\">".str_replace($oldchars, $newchars, $myrow["cons_name"])."</a></strong><br />";
						echo str_replace($oldchars, $newchars, $myrow["link_desc"])."</p>\n";
				...
				{
					echo "<a name=\"T\"></a>";
					$result = mysql_query("SELECT * FROM cons_list WHERE substring(cons_list.cons_name,1,1)='T' ORDER BY cons_name ASC", $db);
					while ($myrow = mysql_fetch_array($result))
					{
						echo "<p><strong><a href=\"linksdetail2.php?ID=".$myrow["cons_id"]."\">".str_replace($oldchars, $newchars, $myrow["cons_name"])."</a></strong><br />";
						echo str_replace($oldchars, $newchars, $myrow["link_desc"])."</p>\n";
				...
				{
					echo "<a name=\"U\"></a>";
					$result = mysql_query("SELECT * FROM cons_list WHERE substring(cons_list.cons_name,1,1)='U' ORDER BY cons_name ASC", $db);
					while ($myrow = mysql_fetch_array($result))
					{
						echo "<p><strong><a href=\"linksdetail2.php?ID=".$myrow["cons_id"]."\">".str_replace($oldchars, $newchars, $myrow["cons_name"])."</a></strong><br />";
						echo str_replace($oldchars, $newchars, $myrow["link_desc"])."</p>\n";
				...
				{
					echo "<a name=\"V\"></a>";
					$result = mysql_query("SELECT * FROM cons_list WHERE substring(cons_list.cons_name,1,1)='V' ORDER BY cons_name ASC", $db);
					while ($myrow = mysql_fetch_array($result))
					{
						echo "<p><strong><a href=\"linksdetail2.php?ID=".$myrow["cons_id"]."\">".str_replace($oldchars, $newchars, $myrow["cons_name"])."</a></strong><br />";
						echo str_replace($oldchars, $newchars, $myrow["link_desc"])."</p>\n";
				...
				{
					echo "<a name=\"W\"></a>";
					$result = mysql_query("SELECT * FROM cons_list WHERE substring(cons_list.cons_name,1,1)='W' ORDER BY cons_name ASC", $db);
					while ($myrow = mysql_fetch_array($result))
					{
						echo "<p><strong><a href=\"linksdetail2.php?ID=".$myrow["cons_id"]."\">".str_replace($oldchars, $newchars, $myrow["cons_name"])."</a></strong><br />";
						echo str_replace($oldchars, $newchars, $myrow["link_desc"])."</p>\n";
				...
				{
					echo "<a name=\"X\"></a>";
					$result = mysql_query("SELECT * FROM cons_list WHERE substring(cons_list.cons_name,1,1)='X' ORDER BY cons_name ASC", $db);
					while ($myrow = mysql_fetch_array($result))
					{
						echo "<p><strong><a href=\"linksdetail2.php?ID=".$myrow["cons_id"]."\">".str_replace($oldchars, $newchars, $myrow["cons_name"])."</a></strong><br />";
						echo str_replace($oldchars, $newchars, $myrow["link_desc"])."</p>\n";
				...
				{
					echo "<a name=\"Y\"></a>";
					$result = mysql_query("SELECT * FROM cons_list WHERE substring(cons_list.cons_name,1,1)='Y' ORDER BY cons_name ASC", $db);
					while ($myrow = mysql_fetch_array($result))
					{
						echo "<p><strong><a href=\"linksdetail2.php?ID=".$myrow["cons_id"]."\">".str_replace($oldchars, $newchars, $myrow["cons_name"])."</a></strong><br />";
						echo str_replace($oldchars, $newchars, $myrow["link_desc"])."</p>\n";
				...
				{
					echo "<a name=\"Z\"></a>";
					$result = mysql_query("SELECT * FROM cons_list WHERE substring(cons_list.cons_name,1,1)='Z' ORDER BY cons_name ASC", $db);
					while ($myrow = mysql_fetch_array($result))
					{
						echo "<p><strong><a href=\"linksdetail2.php?ID=".$myrow["cons_id"]."\">".str_replace($oldchars, $newchars, $myrow["cons_name"])."</a></strong><br />";
						echo str_replace($oldchars, $newchars, $myrow["link_desc"])."</p>\n";
