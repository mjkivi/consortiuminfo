	...
	<a name="startcontent" id="startcontent"></a>
		...
		<div class="LinksMain">
			...
			while ($myrow = mysql_fetch_array($result))
			{
				...
				if ($no_link == 'NoLink') {
					echo "<p style=\"text-align:center;\"><strong>".$consname."</strong></p>\n";
				} else {
					echo "<p style=\"text-align:center;\"><strong><a href=\"".$cons_url."\" target='_blank'>".$consname."</a></strong></p>\n";
				}
			...
			<div class="clear"></div>
			<p style="color:#001c9d; padding-bottom:5px;">&raquo;&nbsp;<a href="linksall.php">Back to Complete List</a></p>
		</div>
</div>
