...
$_DB_name         = 'consor5_geeklog';     // name of your database,
                                   // must exist before running the installer!
$_DB_user         = 'consor5';    // MySQL user name
$_DB_pass         = 'bgt667';    // MySQL password
...
$_CONF['path']            = '/standardsblog/'; // should end in a slash
...
$_CONF['site_url']          = 'http://205.134.252.89/standardsblog';
...
$_CONF['site_name']         = 'ConsortiumInfo.org';
$_CONF['site_slogan']       = 'The Standards Blog';
