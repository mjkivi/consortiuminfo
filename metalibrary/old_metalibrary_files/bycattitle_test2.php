	...
	<div id="mainbody">
		...
		<div id="content2">
			...
			<div class="bodymain">
				...
				echo "<a href=\"/metalibrary/bycat_test2.php?PID=$PID\">By Author</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
				echo "By Title&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
				echo "<a href=\"/metalibrary/bycatdate_test2.php?PID=$PID\">By Date</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
				echo "<a href=\"/metalibrary/bycataccess_test2.php?PID=$PID\">By # Times Accessed</a></p>";
				?>
				...
				$SQL="SELECT * FROM (entries INNER JOIN lookup on entries.id = lookup.entry) WHERE lookup.pid='".$_GET["PID"]."' GROUP BY entries.id ORDER BY entries.title ASC LIMIT $Result_Set, $Per_Page";
				...
				if ($Total>0) { 
					...
					echo "<a href=\"bycattitle_test2.php?Result_Set=$Res1&amp;PID=$PID\">Previous Page</a> "; 
					...
					if ($Pages>1) { 
						for ($b=0,$c=1; $b < $Pages; $b++,$c++) {
							$Res1=$Per_Page * $b; 
							echo "<a href=\"bycattitle_test2.php?Result_Set=$Res1&amp;PID=$PID\"";
					...
					if ($Result_Set>=0 && $Result_Set<$Total) {
						$Res1=$Result_Set+$Per_Page; 
						if ($Res1<$Total) { 
							echo "<a href=\"bycattitle_test2.php?Result_Set=$Res1&amp;PID=$PID\">Next Page</a>";
							echo "</p>";
						} else echo "</p>";
					}
				} //end of total > 0
