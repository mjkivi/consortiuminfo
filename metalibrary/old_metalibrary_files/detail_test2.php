	...
	<div id="mainbody">
			...
			while ($myrow = mysql_fetch_array($result)) {
				$curpid=$myrow["pid"];
					if ($curpid <> $prevpid) { 
						...
						echo " &gt; <a href=\"http://www.consortiuminfo.org/metalibrary/cats_test2.php?PID=".$_GET["PID"]."&amp;ID=".$_GET["ID"]."\">".$myrow["cname"]."</a>";
					}
				$prevpid=$curpid;
			}
			?>
		...
		<div id="content2">
			...
			<div class="bodymain">
				...
				<p class="selectnew" style="margin-bottom:3px;">(<a href="/metalibrary/metalibrary_test2.php">Select a New Topic or Category</a>)</p>
