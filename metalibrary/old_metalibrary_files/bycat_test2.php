	...
	<div id="mainbody">
		...
		<div id="content2">
			...
			<div class="bodymain">
				...
				echo "By Author&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
				echo "<a href=\"/metalibrary/bycattitle_test2.php?PID=$PID\">By Title</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
				...
				if ($Total>0) { 
					...
					echo "<a href=\"bycat_test2.php?Result_Set=$Res1&amp;PID=$PID\">Previous Page</a> "; 
					...
					if ($Pages>1) { 
						for ($b=0,$c=1; $b < $Pages; $b++,$c++) {
							$Res1=$Per_Page * $b; 
							echo "<a href=\"bycat_test2.php?Result_Set=$Res1&amp;PID=$PID\"";
					...
					if ($Result_Set>=0 && $Result_Set<$Total) {
						$Res1=$Result_Set+$Per_Page; 
						if ($Res1<$Total) { 
							echo "<a href=\"bycat_test2.php?Result_Set=$Res1&amp;PID=$PID\">Next Page</a>";
							echo "</p>";
						} else echo "</p>";
					}
				} //end of total > 0
