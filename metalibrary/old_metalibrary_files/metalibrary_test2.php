				...
				<div class="metalinks">
					...
					while ($myrow = mysql_fetch_array($result)) {
						...
						if ($curpid <> $prevpid) {
							...
							echo "<a href=\"/metalibrary/bycat_test2.php?PID=".$myrow["pid"]."\">All Titles</a><br />\n";
						}
						echo "<a href=\"/metalibrary/cats_test2.php?PID=".$myrow["pid"]."&amp;ID=".$myrow["cid"]."\">".$myrow["cname"]."</a><br />\n";
						$prevpid=$curpid;
					}
					echo "</p>\n";
					?>
