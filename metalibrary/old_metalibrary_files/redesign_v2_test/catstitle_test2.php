	...
	<div id="mainbody">
			...
			while ($myrow = mysql_fetch_array($result)) {
				$curpid=$myrow["pid"];
					if ($curpid <> $prevpid) { 
						...
						if ($myrow["cid"] == "8") {
							echo " &gt; Antitrust (see also \"<a href=\"http://www.consortiuminfo.org/metalibrary/old_metalibrary_files/redesign_v2_test/bycat_test2.php?PID=8\">Litigation and Legal Issues</a>\")";
						} elseif ($myrow["cid"] == "29") {
							echo " &gt; IPR Policies (see also \"<a href=\"http://www.consortiuminfo.org/metalibrary/old_metalibrary_files/redesign_v2_test/bycat_test2.php?PID=8\">Litigation and Legal Issues</a>\")";
						} elseif ($myrow["cid"] == "33") {
							echo " &gt; Antitrust (see also \"<a href=\"http://www.consortiuminfo.org/metalibrary/old_metalibrary_files/redesign_v2_test/bycat_test2.php?PID=3\">Economics</a>\")";
						} elseif ($myrow["cid"] == "34") {
							echo " &gt; Intellectual Property Rights (see also \"<a href=\"http://www.consortiuminfo.org/metalibrary/old_metalibrary_files/redesign_v2_test/bycat_test2.php?PID=7\">separate category of the same name</a>\")";
						} else {
							echo " &gt; ".$myrow["cname"];
						}
					}
		...
		<div id="content2">
			...
			<div class="bodymain">
				...
				echo "<a href=\"/metalibrary/old_metalibrary_files/redesign_v2_test/cats_test2.php?PID=$PID&amp;ID=$ID\">By Author</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
				echo "By Title&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
				echo "<a href=\"/metalibrary/old_metalibrary_files/redesign_v2_test/catsdate_test2.php?PID=$PID&amp;ID=$ID\">By Date</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
				echo "<a href=\"/metalibrary/old_metalibrary_files/redesign_v2_test/catsaccess_test2.php?PID=$PID&amp;ID=$ID\">By # Times Accessed</a></p>";
				?>
				...
				if ($Total>0) { 
					...
					$Res1=$Result_Set-$Per_Page;
						echo "<a href=\"catstitle_test2.php?Result_Set=$Res1&amp;PID=$PID&amp;ID=$CID\">Previous Page</a> "; 
					...
					if ($Pages>1) { 
						for ($b=0,$c=1; $b < $Pages; $b++,$c++) {
							$Res1=$Per_Page * $b; 
							echo "<a href=\"catstitle_test2.php?Result_Set=$Res1&amp;PID=$PID&amp;ID=$CID\"";
					...
					$Res1=$Result_Set+$Per_Page; 
						if ($Res1<$Total) { 
							echo " <a href=\"catstitle_test2.php?Result_Set=$Res1&amp;PID=$PID&amp;ID=$CID\">Next Page</a>";
							echo "</p>";
						} else echo "</p>";
					}
				} 
