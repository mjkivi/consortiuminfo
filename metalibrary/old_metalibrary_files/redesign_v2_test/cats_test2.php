	...
	<div id="mainbody">
		...
		<div id="content2">
			...
			<div class="bodymain">
				...
				echo "By Author&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
				echo "<a href=\"/metalibrary/old_metalibrary_files/redesign_v2_test/catstitle_test2.php?PID=$PID&amp;ID=$ID\">By Title</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
				...
				if ($Total>0) { 
					...
					$Res1=$Result_Set-$Per_Page;
						echo "<a href=\"cats_test2.php?Result_Set=$Res1&amp;PID=$PID&amp;ID=$CID\">Previous Page</a> "; 
					...
					if ($Pages>1) { 
						for ($b=0,$c=1; $b < $Pages; $b++,$c++) {
							$Res1=$Per_Page * $b; 
							echo "<a href=\"cats_test2.php?Result_Set=$Res1&amp;PID=$PID&amp;ID=$CID\"";
					...
					$Res1=$Result_Set+$Per_Page; 
						if ($Res1<$Total) { 
							echo " <a href=\"cats_test2.php?Result_Set=$Res1&amp;PID=$PID&amp;ID=$CID\">Next Page</a>";
							echo "</p>";
						} else echo "</p>";
					}
				} 
