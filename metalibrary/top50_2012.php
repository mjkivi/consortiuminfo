	...
	<div id="mainbody">
		...
		<div id="content2">
			...
			<div class="bodymain">
				...
				<h3 style="text-align:left">50 Most Accessed MetaLibrary Articles of 2012</h3>
				<div class="clear"></div>
				...
				$SQL="SELECT * FROM entries WHERE entries.accessed_2010 > 0 GROUP BY entries.id ORDER BY entries.accessed_2010 DESC LIMIT 50";
				...
				$accessed_2010=$SQL_Array['accessed_2012'];
				...
				if
				($accessed_2010 > 0){
				echo " <em>[Accessed $accessed_2010 times in 2010]</em>";
				}
