...
<body id="bulletin">
	...
	<div id="banner">
		<div class="left">
			<p><a href="/">Home</a> &gt; <a href="index.php">MetaLibrary</a> &gt; Search Results</p>
		</div>
		<!--   SEARCH FORM   -->
	...
	<div id="mainbody">
		...
		<div id="content2">
			...
			<div class="bodymain">
				...
				while ($row = str_replace($slashesetc, $repslashesetc, mysql_fetch_array($queryResource,MYSQL_ASSOC))) {
					if ($row["score"]>=1) {
						echo "<p style=\"margin-bottom:20px;\">";
						echo ( "<strong>Title:</strong> <a href=\"/metalibrary/out2.php?EID=".$row['id']."\">".$row['title']."</a><br />" );
